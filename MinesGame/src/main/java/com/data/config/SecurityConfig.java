    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
            .authorizeRequests(auth -> auth
                ...
                .requestMatchers("/auth/login","/api/version","/api/{roomCode}/leaderboard","/getallusers","/api/admin/create-room","/api/{roomCode}/game-cashouts","/rooms/{roomCode}/games/{gameId}/cashout","/api/join-room","/rooms/{roomCode}/games/start","/rooms/{roomCode}/games/move", "/auth/register", "/auth/", "/").permitAll()
